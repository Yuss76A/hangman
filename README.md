...
*Username Input*<br>
![Username Validation](docs/screenshots/invaliduser.png)
...
| Word Selection | Select a random word from word_list, the primary database of words. | Run the game to see if a word can be successfully retrieved. | Word should be selected at random from word_list. | Successful. |
